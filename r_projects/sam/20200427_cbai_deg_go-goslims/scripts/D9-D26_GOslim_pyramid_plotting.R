...
df1 <- read.csv("analyses/D9-D26/P0.05_C1.D9-UP.subset.GOseq.enriched.flattened.FDR_1.0.BP.GOslims.csv")

# Read in second comparison file
df2 <- read.csv("analyses/D9-D26/P0.05_C1.D26-UP.subset.GOseq.enriched.flattened.FDR_1.0.BP.GOslims.csv")
