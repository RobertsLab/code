...
#####################################################
# Comparison
comparison <- "ambient-cold"

# Treatments
treatment_01 <- "ambient"
treatment_02 <- "cold"

# Read in first comparsion files
df1 <- read.csv("analyses/ambient-cold/P0.05_C1.ambient-UP.subset.GOseq.enriched.flattened.FDR_1.0.BP.GOslims.csv")

# Read in second comparison file
df2 <- read.csv("analyses/ambient-cold/P0.05_C1.cold-UP.subset.GOseq.enriched.flattened.FDR_1.0.BP.GOslims.csv")
