...
df1 <- read.csv("analyses/ambient-warm/P0.05_C1.ambient-UP.subset.GOseq.enriched.flattened.FDR_1.0.BP.GOslims.csv")

# Read in second comparison file
df2 <- read.csv("analyses/ambient-warm/P0.05_C1.warm-UP.subset.GOseq.enriched.flattened.FDR_1.0.BP.GOslims.csv")
