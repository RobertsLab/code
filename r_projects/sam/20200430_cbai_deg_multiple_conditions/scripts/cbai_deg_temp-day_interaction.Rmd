---
title: "cbai_deg_temp-day_interaction"
...
### Differential Expression of _C.bairdi_ Genes Across Infection Status and Time Points Using DESeq2
...
Have to use esimateSizeFactors outside of typical `vst()` because all genes contain a sample with zero. Using `type = "poscounts"` adjusts for this.
...
ann_colors <-  list(time_point=c(Eggs="darkgreen", Fertilized_embryos="darkgreen", Cleavage="cadetblue4", Prawn_chip="deepskyblue", Gastrulation="cornflowerblue", Morulae="blueviolet", Blastula="darkorchid4", Planulae="deeppink4"), treatment= c(AMB="chartreuse", l="pink", xl="violetred3"))#, treatment=AMB="chartreuse", l="pink", xl="violetred3")
df1 <- as.data.frame(colData(DEGvst)[c("time_point", "treatment")]) #make dataframe for column naming 
DEGheatmap <- pheatmap(mat, scale="row", annotation_col=df1, annotation_colors = ann_colors,
