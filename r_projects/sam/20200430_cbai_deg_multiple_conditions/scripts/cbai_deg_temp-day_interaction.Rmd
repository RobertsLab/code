...
ann_colors <-  list(day=c(D9="darkgreen", D12="cadetblue4", D26="deepskyblue"), infection_status= c(infected="chartreuse", uninfected="violetred3"))#, treatment=AMB="chartreuse", l="pink", xl="violetred3")
