...
```{bash retrieve-gene-fastas, engine='bash', eval=TRUE}
# Load bash variables into memory
source .bashvars

/home/sam/edirect/esearch -db nuccore -query "NM_001305360.1"
```
| ${efetch} -format fasta > "${data_dir}"/NM_001305360.1.fasta
```
