...
Primer set #3 looks to be the best option.


```{r extract-NM_001305360.1-primers, engine='bash', eval=TRUE}
source .bashvars

grep -A 3 "3 LEFT PRIMER" "${output_top}/NM_001305360.1-primer3-primers.txt"
```
